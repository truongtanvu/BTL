...
public class ThongtinKH  extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên KH", "Mã KH", "Số điện thoại", "Địa chỉ"
            }
        ));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnTroLai, javax.swing.GroupLayout.DEFAULT_SIZE, 113, Short.MAX_VALUE))
    ...
    {
        try {
            conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl1","vudepdai", "admin123a");
            st = conn.createStatement();
            rs = st.executeQuery("select * from THONGTINKH ");
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty())
        {
            ...
            try {
                conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:BTLJava", "vudepdai", "admin123a");
                ...
                JOptionPane.showMessageDialog(this, "Đã thêm thông tin khách hàng");
                conn.close();
